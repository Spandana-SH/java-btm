class MallInfo{
 public static void main(String[] args){
	...
	short noOfFloor=15;
	short noOfShops=45;
	short noOfRestraurants=15;
	short twoWheelerSlots=100;
	short fourWheelerSlots=120;
	...
	short noOfBoysShps=20;
	short noOfKidsShops=9;
	String email="orionmall@gmail.com";
	System.out.println(name);
	System.out.println(noOfFloor);
	System.out.println(noOfShops);
	System.out.println(noOfRestraurants);
	...
	System.out.println(noOfBoysShps);
